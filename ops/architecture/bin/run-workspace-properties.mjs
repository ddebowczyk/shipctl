...
const properties = [
  ...
  },
  {
    ...
    classifications: {
      ...
      retention: ["identity", "open-views", "missing"],
    },
  },
  {
    propertyId: "PROP-G-WORKSPACE-OPERATIONS-001",
    testId: "architecture.workspace-public-operations.property",
    classifications: {
      operation: [
        "validate",
        "plan",
      ...
      execution: ["rendererless", "atomic-batch", "one-revision", "conflict"],
    },
  },
  {
