...
const evidenceDirectory = path.join(
  repositoryRoot,
  "target/architecture-evidence/git-extraction",
);
...
const typescriptTests = [
  ...
  "ops/architecture/tests/gitNativeExtraction.test.mjs",
  "modules/git/frontend/tests/gitCharacterization.test.ts",
  "modules/git/frontend/tests/markdownRenderer.test.ts",
];
const environment = {
  ...process.env,
...
const replayCommand = `node ops/architecture/bin/run-git-extraction-properties.mjs --seed=${seed}`;
const properties = [
  {
    propertyId: "PROP-D-PARITY-001",
    testId: "architecture.provider.git.parity.property",
    language: "rust",
    library: "proptest",
    version: "1.11.0",
    classifications: {
      capability: ["git"],
      outcomes: ["status", "files", "changed-files"],
    },
  },
  {
    propertyId: "PROP-D-AUTHORITY-001",
    testId: "architecture.provider.git.authority.property",
    language: "rust",
    library: "proptest",
    version: "1.11.0",
    classifications: {
  ...
  },
  {
    ...
    testId: "architecture.provider.git.ownership.property",
    language: "rust",
    library: "proptest",
    version: "1.11.0",
    classifications: {
      capability: ["git"],
      ownership: ["activation-access", "repository-state"],
    },
  },
  {
    propertyId: "PROP-D-CLOSURE-001",
    testId: "architecture.git-native-extraction-closure.property",
    language: "typescript",
    library: "fast-check",
