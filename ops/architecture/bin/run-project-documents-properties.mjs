...
const evidenceDirectory = path.join(
  repositoryRoot,
  "target/architecture-evidence/project-documents",
);
...
const properties = [
  {
    ...
    classifications: {
      operations: ["discoverDocuments", "readDocument"],
  ...
  },
  {
    ...
    classifications: {
      outcomes: ["invalid-path", "cancelled", "success", "disposed"],
  ...
  },
  {
    ...
    testId: "architecture.project-documents-service-fake.property",
    classifications: {
      operations: ["create", "conflict", "update", "read"],
