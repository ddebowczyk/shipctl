...
const evidenceDirectory = path.join(
  repositoryRoot,
  "target/architecture-evidence/skill-installation",
);
...
const properties = [
  {
    ...
    testId: "architecture.service-adapter.skill-installation.property",
    classifications: {
      operations: ["inspect", "install", "remove"],
      outcomes: ["success", "stable-error"],
    },
  },
  {
    propertyId: "PROP-B-REQUEST-001",
    testId: "architecture.service-request.skill-installation.property",
    classifications: {
  ...
  },
  {
    ...
    testId: "architecture.skill-installation-service-fake.property",
    classifications: {
      operations: ["inspect", "install", "remove"],
