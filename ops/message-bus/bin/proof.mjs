...
const sharedGoldens = path.join(repositoryRoot, "module-api", "fixtures", "protocol", "messages.json");
const fixtureManifest = path.join(repositoryRoot, "examples", "module-fixture", "module.yaml");
const fixtureSchema = path.join(repositoryRoot, "examples", "module-fixture", "messages", "agent-wakeup.schema.json");
