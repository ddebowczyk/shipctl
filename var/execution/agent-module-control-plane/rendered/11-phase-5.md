...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/05-generic-lifecycle-and-reconfiguration.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/11-phase-5
```

## Execution process

1. Claim this subepic (`shep-btu.11`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 5: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 5`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Live runtime supervisor.
- Next ordered subepic: Current module migration.
