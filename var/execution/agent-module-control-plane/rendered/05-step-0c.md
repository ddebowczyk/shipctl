...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/00c-named-instance-foundation-implementation.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/05-step-0c
```

## Execution process

1. Claim this subepic (`shep-btu.5`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Step 0C: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Step 0C`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Saved instance state specification.
- Next ordered subepic: Module contracts and loader test kernel.
