...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/01-durable-registry-and-offline-inspection.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/07-phase-1
```

## Execution process

1. Claim this subepic (`shep-btu.7`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 1: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 1`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Module contracts and loader test kernel.
- Next ordered subepic: Running-instance control plane.
