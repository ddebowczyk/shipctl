...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/03-artifacts-capabilities-and-preflight.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/09-phase-3
```

## Execution process

1. Claim this subepic (`shep-btu.9`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 3: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 3`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Running-instance control plane.
- Next ordered subepic: Live runtime supervisor.
