...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/02-running-instance-control-plane.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/08-phase-2
```

## Execution process

1. Claim this subepic (`shep-btu.8`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 2: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 2`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Durable registry and offline inspection.
- Next ordered subepic: Artifacts, capabilities, and preflight.
