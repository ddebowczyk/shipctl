...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/08-full-application-verification.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/14-phase-8
```

## Execution process

1. Claim this subepic (`shep-btu.14`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 8: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 8`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Agent development loop.
- After this final subepic, verify and close the parent epic.
