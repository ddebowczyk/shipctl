# Plan contract — Agent-operated capability module control plane
...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/README.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/01-plan-contract
```

## Execution process

1. Claim this subepic (`shep-btu.1`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Plan contract: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Plan contract`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Next ordered subepic: Execution order and task contract.
