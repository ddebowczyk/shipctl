...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/06-current-module-migration.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/12-phase-6
```

## Execution process

1. Claim this subepic (`shep-btu.12`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 6: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 6`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Generic lifecycle and reconfiguration.
- Next ordered subepic: Agent development loop.
