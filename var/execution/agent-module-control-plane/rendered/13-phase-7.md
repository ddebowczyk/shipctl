...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/07-agent-development-loop.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/13-phase-7
```

## Execution process

1. Claim this subepic (`shep-btu.13`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 7: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 7`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Current module migration.
- Next ordered subepic: Full-application verification.
