...
```text
/Users/ddebowczyk/projects/_ext_experiments/shep/docs/plans/20260808-090754-agent-module-control-plane/04-live-runtime-supervisor.md
```
...
```text
var/execution/agent-module-control-plane/action-plans/10-phase-4
```

## Execution process

1. Claim this subepic (`shep-btu.10`) and record the live branch, commit,
...
11. Review the exact diff, stage only phase-owned changes, and commit them. The
    ...
    `phase Phase 4: complete <outcome>`.
...
- The phase commit exists and its subject identifies `Phase 4`.
- This subepic and all descendants are closed before execution advances.

## Transition

- Previous ordered subepic: Artifacts, capabilities, and preflight.
- Next ordered subepic: Generic lifecycle and reconfiguration.
