...
use crate::input::{focus_event, TerminalInput};
...
use crate::{TerminalClipboardContent, TerminalClipboardLocation, TerminalEffect};
...
impl VtReplayEngine {
    ...
    /// before it.
    pub fn project(&mut self) -> Result<crate::projection::TerminalProjection, String> {
        crate::projection::project(&self.terminal, &mut self.render)
    }
    ...
    pub fn project_baseline(&mut self) -> Result<crate::projection::TerminalProjection, String> {
        let mut baseline = RenderState::new().map_err(|error| error.to_string())?;
        crate::projection::project(&self.terminal, &mut baseline)
    }
    ...
    pub fn project_history(
        ...
        crate::projection::project_history(&self.terminal, start_row, rows)
    }
