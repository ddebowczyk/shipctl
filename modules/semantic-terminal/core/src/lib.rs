//! Tauri-free semantic-terminal model and native driver.
//!
//! This crate owns parser integration, projection, input encoding, and the
//! semantic terminal driver. The sibling `backend` crate owns Tauri commands.
