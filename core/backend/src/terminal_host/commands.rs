...
use crate::terminal_host::runtime::{
    PublishedTerminalEvent, TerminalEventSink, TerminalPublicationStats,
};
use crate::terminal_host::service::{TerminalRegistryEventSink, TerminalService};
use crate::terminal_host::types::{
...
impl TerminalEventSink for TauriTerminalEventSink {
    fn publish(
        &self,
        _terminal_id: crate::terminal_host::types::TerminalId,
        event: TerminalEvent,
    ) -> Result<(), String> {
