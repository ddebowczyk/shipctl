//! Compact, lossless screen snapshots for transport.
//!
...
use super::projection::{
    ProjectedCell, ProjectedColor, ProjectedCursor, ProjectedDamage, ProjectedDamageScope,
    ProjectedModes, ProjectedPrompt, ProjectedRow, ProjectedScreen, ProjectedWidth,
    TerminalProjection,
};
...
pub struct TerminalScreenSnapshot {
    ...
    pub colors: super::projection::ProjectedColors,
...
mod tests {
    use super::*;
    use crate::terminal::projection::{ProjectedColors, ProjectedDamageScope};
    ...
    fn runs_keep_one_glyph_per_host_cell_and_selection_is_an_overlay() {
        let projection = TerminalProjection {
            ...
            cursor: ProjectedCursor {
                ...
                visible: true,
                pending_wrap: false,
                shape: super::super::projection::ProjectedCursorShape::Block,
                blinking: false,
            },
