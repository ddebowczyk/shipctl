//! Semantic state painted as local terminal output.
//!
...
use crate::semantic_terminal::TerminalEffect;
...
fn finish_frame(
    ...
    cursor: crate::semantic_terminal::projection::ProjectedCursor,
) {
...
mod tests {
    use super::*;
    use crate::semantic_terminal::{TerminalClipboardContent, TerminalClipboardLocation};
