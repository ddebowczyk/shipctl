//! Continuous native VT state and exact reset-target replay.
//!
...
impl VtReplayEngine {
    ...
    pub fn project(
        &mut self,
    ) -> Result<crate::semantic_terminal::projection::TerminalProjection, String> {
        crate::semantic_terminal::projection::project(&self.terminal, &mut self.render)
    }
    ...
    pub fn project_baseline(
        ...
        crate::semantic_terminal::projection::project(&self.terminal, &mut baseline)
    }
    ...
    pub fn project_history(
        ...
        crate::semantic_terminal::projection::project_history(&self.terminal, start_row, rows)
    }
