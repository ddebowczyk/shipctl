//! Ghostty semantic compatibility corpus for the permanent provider.
//!
...
//!
//! Retention is deliberately absent: [`crate::semantic_terminal::retention`] is the single
...
use crate::semantic_terminal::libghostty_vt::{
    focus,
...
use crate::semantic_terminal::retention::TerminalRetentionPolicy;
...
fn grid_point<'t>(
    ...
    x: u16,
    y: u16,
) -> crate::semantic_terminal::libghostty_vt::screen::GridRef<'t> {
    terminal
...
/// *amount* of history is measured in [`crate::semantic_terminal::retention`]; this proves the
...
fn the_child_owns_the_palette_and_the_default_colors() {
    ...
    assert_eq!(
        palette.get(crate::semantic_terminal::libghostty_vt::style::PaletteIndex(1)),
        RgbColor {
            r: 0x01,
            g: 0x02,
            b: 0x03
...
fn facts_copied_out_stay_valid_after_the_terminal_moves_on() {
    ...
    assert_eq!(
        ...
        terminal
            .color_palette()
            .expect("palette")
            .get(crate::semantic_terminal::libghostty_vt::style::PaletteIndex(1))
    );
