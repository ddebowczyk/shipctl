//! What one frame of semantic state costs the semantic-terminal provider.
//!
...
//!
//! ```text
//! cargo test -p shipctl-core --lib --release semantic_terminal::measure -- --ignored --nocapture
//! ```
//!
