...
export interface StandardWorkspaceNavigationFooterProps {
...
export default function StandardWorkspaceNavigationFooter({
  navigation,
  activeSurfaceId,
  onToggleSurface,
}: StandardWorkspaceNavigationFooterProps) {
