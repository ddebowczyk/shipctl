...
export interface TerminalDescriptor {
  ...
  /** Immutable implementation selection for this terminal session. */
  readonly driverId: import("@shipctl/module-api").TerminalDriverId;
...
export interface TerminalLaunchRequest {
  /** When omitted, the host resolves the build's configured default driver. */
  readonly driverId?: import("@shipctl/module-api").TerminalDriverId;
...
/** A successful host close has also removed the frontend projection. */
export type TerminalCloseOutcome = { readonly status: "closed" };
...
/** The host raw stream is opaque to the selected terminal presentation. */
export interface TerminalRawAttachmentBootstrap {
